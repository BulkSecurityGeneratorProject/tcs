...
import { Superior, SuperiorService } from '../superior';
...
export class EmployeeDialogComponent implements OnInit {
    ...
    ngOnInit() {
        this.isSaving = false;
        this.superiorService.query()
            .subscribe((res: ResponseWrapper) => { this.superiors = res.json; }, (res: ResponseWrapper) => this.onError(res.json));
    }
    ...
    trackSuperiorById(index: number, item: Superior) {
        return item.id;
    }
}
