...
import com.example.mypackage.config.audit.AuditEventConverter;
import com.example.mypackage.domain.PersistentAuditEvent;
...
import static com.example.mypackage.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
